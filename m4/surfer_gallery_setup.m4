...
dnl let assume that English is the default language
dnl (so there is no alternative to English)
SURFER_GALLERY_ALTERNATIVE_LANGUAGE_en=""
AC_SUBST(SURFER_GALLERY_ALTERNATIVE_LANGUAGE_en)

SURFER_GALLERY_ALTERNATIVE_LANGUAGE_de="en"
AC_SUBST(SURFER_GALLERY_ALTERNATIVE_LANGUAGE_de)

SURFER_GALLERY_ALTERNATIVE_LANGUAGE_es="en"
AC_SUBST(SURFER_GALLERY_ALTERNATIVE_LANGUAGE_es)

SURFER_GALLERY_ALTERNATIVE_LANGUAGE_ca="es"
AC_SUBST(SURFER_GALLERY_ALTERNATIVE_LANGUAGE_ca)

SURFER_GALLERY_ALTERNATIVE_LANGUAGE_ga="es"
AC_SUBST(SURFER_GALLERY_ALTERNATIVE_LANGUAGE_ga)
